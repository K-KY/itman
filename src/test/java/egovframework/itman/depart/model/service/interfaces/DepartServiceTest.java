...
class DepartServiceTest {
    ...
    void setUp() {
            departService.insert(DepartDto.Request.builder().name("test" + 1).build());
    }
    ...
    void insert() {
        departService.insert(DepartDto.Request.builder().name("test").build());
        Page<DepartDto.Response> read = departService.read(PageRequest.of(0, 1));
        assertThat(read.getContent().get(0).getName()).isEqualTo("test");
    }
    ...
    void read() {
        ...
        assertThat(read.getContent().get(0).getName()).isEqualTo("test" + 1);
    }
...
//        departService.update(DepartDto.Request.builder().name()("test").build());
...
//        assertThat(read.getContent().get(0).getDepartName()).isEqualTo("test");
    ...
    @Transactional
    void delete() {
        DepartDto.Response insert = departService.insert(DepartDto.Request.builder().name("test" + 1).build());
        boolean delete = departService.delete(DepartDto.Request.builder().seq(1).build());
